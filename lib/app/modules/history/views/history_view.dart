...
import 'package:zenzone/app/data/models/response_history_peminjaman.dart';
import 'package:zenzone/app/modules/history/controllers/history_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: controller.obx(
        (state) => SafeArea(
          child: Container(
            color: const Color.fromRGBO(101, 0, 161, 0.7),
...
class ContentKoleksi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: const Color(0xFF008A93)),
