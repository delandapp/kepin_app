...
import 'package:zenzone/app/data/models/response_buku.dart';
import 'package:zenzone/app/data/models/response_bookSearch.dart';
...
class ExploreController extends GetxController with StateMixin<List<DataBuku>> {
